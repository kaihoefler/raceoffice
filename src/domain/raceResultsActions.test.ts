 ...
 * - aus Activities abgeleitete Felder prüfen (points / dnf / dsq / dns)
 ...
 *   `dnf` ODER `dsq` ODER `dns`
 * - Kombinationen wie gleichzeitig `dns=true` und `dnf=true` gelten hier
...
function dnfActivity(id: string, lap: number, bibs: number[], isDeleted = false): RaceActivityDNF {
  return {
    id,
    createdAt: `${id}-createdAt`,
    type: "DNF",
...
describe("raceResultsActions", () => {
  ...
  describe("applyActivitiesToRaceResults", () => {
    it("derives points, eliminations, DSQ and DNS while preserving manual fields", () => {
      ...
      const next = applyActivitiesToRaceResults({
        prevResults,
        starters: [athlete(11), athlete(12), athlete(13), athlete(14), athlete(15), athlete(16)],
        activities: [
      ...
      // - bib 15: nur DNS
      // - bib 16: normales DNF (nicht Elimination)
      expect(next).toEqual([
        {
          bib: 11,
          rank: 0,
    ...
    it("ignores deleted activity effects and keeps stable ordering of previous rows before new bibs", () => {
      ...
      expect(next.find((r) => r.bib === 2)?.dnf).toBe(false);
  ...
  describe("sortRaceResultsForStandings", () => {
    it("sorts by status bucket, then elimination lap, then points, then finish rank", () => {
      ...
      //   zuerst die dnfLap verglichen wird.
  ...
  describe("recomputeRaceResults", () => {
    it("assigns ranks with ties and keeps the original output order", () => {
      const input = [
        ...
        raceResult({ bib: 40, dnf: "elimination", dnfLap: 9 }),
      ];
    ...
    it("assigns the same rank to riders dnf in the same lap, regardless of points/finishRank", () => {
      const input = [
        ...
        raceResult({ bib: 513, dnf: "elimination", dnfLap: 24, points: 7, finishRank: 16 }),
        raceResult({ bib: 445, dnf: "elimination", dnfLap: 24, points: 0, finishRank: 17 }),

        // spätere Platzierung, weil geringere Eliminationsrunde
        raceResult({ bib: 471, dnf: "elimination", dnfLap: 23, points: 0, finishRank: 0 }),
      ];
    ...
    it("assigns the same rank to riders with dnfType=dnf in the same lap", () => {
      const input = [
        raceResult({ bib: 100, points: 5, finishRank: 1 }),
        raceResult({ bib: 200, points: 2, finishRank: 2 }),

        // gleiches DNF-Lap (dnfType='dnf'), aber absichtlich unterschiedliche Werte:
        raceResult({ bib: 601, dnf: "dnf", dnfLap: 20, points: 9, finishRank: 11 }),
        raceResult({ bib: 602, dnf: "dnf", dnfLap: 20, points: 0, finishRank: 12 }),

        // spätere Platzierung, weil geringere DNF-Runde
  ...
  describe("recomputeRaceResults - real race sample", () => {
    it("recomputes the expected ranks for the real race sample", () => {
      const realRaceResults: RaceResult[] = [
        raceResult({ bib: 347, rank: 0, points: 8, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:03.873", finishRank: 1 }),
        raceResult({ bib: 304, rank: 0, points: 6, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:03.899", finishRank: 2 }),
        raceResult({ bib: 303, rank: 0, points: 1, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:07.349", finishRank: 3 }),
        raceResult({ bib: 348, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:07.575", finishRank: 4 }),
        raceResult({ bib: 359, rank: 0, points: 9, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:08.270", finishRank: 5 }),
        raceResult({ bib: 312, rank: 0, points: 10, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 25, finishTime: "8:08.818", finishRank: 6 }),
        raceResult({ bib: 369, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 24, finishTime: "", finishRank: 7 }),
        raceResult({ bib: 349, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 23, finishTime: "", finishRank: 8 }),
        raceResult({ bib: 358, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 20, finishTime: "", finishRank: 9 }),
        raceResult({ bib: 345, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 18, finishTime: "", finishRank: 10 }),
        raceResult({ bib: 342, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 16, finishTime: "", finishRank: 11 }),
        raceResult({ bib: 371, rank: 0, points: 0, dnf: false, dnfLap: 0, dns: false, dsq: false, lapsCompleted: 14, finishTime: "", finishRank: 12 }),
        raceResult({ bib: 298, rank: 0, points: 0, dnf: "elimination", dnfLap: 17, dns: false, dsq: false, lapsCompleted: 12, finishTime: "", finishRank: 13 }),
        raceResult({ bib: 352, rank: 0, points: 0, dnf: "elimination", dnfLap: 16, dns: false, dsq: false, lapsCompleted: 11, finishTime: "", finishRank: 14 }),
        raceResult({ bib: 383, rank: 0, points: 0, dnf: "elimination", dnfLap: 15, dns: false, dsq: false, lapsCompleted: 8, finishTime: "", finishRank: 15 }),
        raceResult({ bib: 294, rank: 17, points: 0, dnf: "elimination", dnfLap: 15, dns: false, dsq: false, lapsCompleted: 6, finishTime: "", finishRank: 16 }),
        raceResult({ bib: 302, rank: 18, points: 0, dnf: "elimination", dnfLap: 14, dns: false, dsq: false, lapsCompleted: 5, finishTime: "", finishRank: 17 }),
        raceResult({ bib: 331, rank: 20, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 18 }),
        raceResult({ bib: 356, rank: 21, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 19 }),
        raceResult({ bib: 297, rank: 22, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 20 }),
        raceResult({ bib: 301, rank: 23, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 21 }),
        raceResult({ bib: 325, rank: 24, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 22 }),
        raceResult({ bib: 355, rank: 25, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 23 }),
        raceResult({ bib: 350, rank: 19, points: 2, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 24 }),
        raceResult({ bib: 326, rank: 26, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 25 }),
        raceResult({ bib: 366, rank: 27, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 26 }),
        raceResult({ bib: 380, rank: 28, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 27 }),
        raceResult({ bib: 313, rank: 29, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 28 }),
        raceResult({ bib: 324, rank: 30, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 29 }),
        raceResult({ bib: 353, rank: 31, points: 0, dnf: false, dnfLap: 0, dns: true, dsq: false, lapsCompleted: 0, finishTime: "", finishRank: 30 }),
      ];
  ...
  describe("materializeRaceResults", () => {
    it("derives activity fields first and then computes ranks", () => {
      ...
      expect(materialized.map((r) => ({ bib: r.bib, points: r.points, dnf: r.dnf, rank: r.rank }))).toEqual([
        { bib: 1, points: 3, dnf: false, rank: 1 },
        { bib: 2, points: 2, dnf: false, rank: 2 },
        { bib: 3, points: 0, dnf: "elimination", rank: 3 },
      ]);
    });
  });
});
